...
// creating connection with database and specifying the database to work with
...
// route to send data to datatable
...
// route to render create employee page
app.get("/create", function (req, res) {
	res.render("create");
});

// route to handle post request and save the new employee data
app.post("/create", function (req, res) {

	// fetching values from form data
...
// route to handle post request from the update employee details form
...
// route to handle post request to delete selected user
...
// route to set the port on which the server runs
